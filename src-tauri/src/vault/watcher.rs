...
mod tests {
    ...
    fn test_is_hidden() {
        ...
        assert!(VaultWatcher::is_hidden(Path::new("/vault/.hidden/note.md"), vault));
        assert!(VaultWatcher::is_hidden(Path::new("/vault/.git/config"), vault));
        assert!(!VaultWatcher::is_hidden(Path::new("/vault/note.md"), vault));
        assert!(!VaultWatcher::is_hidden(Path::new("/vault/subdir/note.md"), vault));
    }
